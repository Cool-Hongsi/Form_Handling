...
import { formMockData } from 'mock/store/orderReducerMockData';
import { Provider } from 'react-redux';
import { fillForm, addLoadForm, deleteLoadForm } from 'redux/order/orderAction';
...
describe('src/layout/form/LoadForm', () => {
  let store: Store;
