...
import { tableCompMockData } from 'mock/store/orderReducerMockData';
import { orderModelMockData } from 'mock/data/orderModelMockData';
import { Provider } from 'react-redux';
import { clickCheckBox, copyOrderForm } from 'redux/order/orderAction';
...
describe('src/layout/table/TableComp', () => {
  let store: Store;
