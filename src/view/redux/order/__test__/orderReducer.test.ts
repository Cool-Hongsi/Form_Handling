...
describe('src/view/redux/order/orderReducer', () => {
  ...
  describe('Additional actions', () => {
    it('test fillForm action', () => {
      const inputData: OnChangeEventType = {
        type: 'baseForm',
        name: BASE_NAME,
        value: 'test text',
      };
    ...
    it('test addValidationErrorMsg action', () => {
      const inputData: AddValidationErrorMsgInputDataType = {
        tempBaseForm: {
          [BASE_NAME]: {
    ...
    it('test copyOrderForm action', () => {
      const copyOrderFormParam: CopyOrderFormInputDataType = {
        baseForm: {
