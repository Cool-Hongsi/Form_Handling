...
// Default
export const defaultMockData: OrderState = {
  getOrderApi: {
    loading: false,
    error: null,
    result: [],
...
export const deleteOrderApiResultMockData: OrderState = {
  ...defaultMockData,
  deleteOrderApi: { result: 'Test Data' },
};

// PostOrderApi Result
export const postOrderApiResultMockData: OrderState = {
  ...defaultMockData,
  postOrderApi: { result: orderModelMockData },
};

// Pagination
export const paginationMockData: OrderState = {
  ...defaultMockData,
  tableData: { splittedResult: [], rowCount: 0, totalPage: 5, currentPage: 1, deleteList: [] },
};

// TableComp
export const tableCompMockData: OrderState = {
  ...defaultMockData,
  tableData: {
...
export const formMockData: OrderState = {
  ...defaultMockData,
  inputData: {
    baseForm: {
      [BASE_NAME]: {
